/*12 Agregar al menú del problema anterior 
la opción de búsqueda por mes y día de nacimiento*/

//FALTA HACER FUNCION PEDIDA
...
int opc;
	do{
		...
		printf("\n\t 3.- Busqueda Por Apellido y Modificacion. ");  
		printf("\n\t 4.- Busqueda Por Mes y Dia y Modificacion. ");  
		printf("\n\t 5.- Salir ");
		printf("\n\n\t\t Ingrese opcion: ");
		scanf("%d", &opc);
		fgetc(stdin);
